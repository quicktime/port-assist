// src/screens/Portfolio/CombinedPortfolioDashboard.tsx
...
export default function CombinedPortfolioDashboard() {
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        <Appbar.Header>
          <Appbar.Content title="My Portfolio" />
          <Appbar.Action
          ...
          {activeTab === 'overview' && (
            <>
              ...
              <View style={styles.sectionHeader}>
                ...
                <Button 
                  mode="text"
                  onPress={() => router.push('/options-portfolio')}
                  icon="chevron-right"
                  contentStyle={{ flexDirection: 'row-reverse' }}
                >
                  View All
              ...
              <View style={styles.actionsContainer}>
                ...
                <Button
                  ...
                  icon="plus"
                  style={styles.actionButton}
                  onPress={() => router.push('/add-option-position')}
                >
                  Add Option
                </Button>
              </View>
