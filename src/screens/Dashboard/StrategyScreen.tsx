// src/screens/Dashboard/StrategyScreen.tsx
...
export default function StrategyScreen() {
  ...
  if (loading) {
    return <LoadingScreen title="Trading Strategy" message="Loading strategy preferences..." />;
  }
  
  return (
    <BaseScreen title="Trading Strategy" showBackButton={true} onBack={() => router.back()}>
